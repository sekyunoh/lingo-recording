...
public typealias DidDoubleTap = (view: UIView, atLocation: CGPoint) -> ()
...
public class ZLSwipeableView: UIView {
    ...
    public var didDoubleTap: DidDoubleTap?
...
internal class ViewManager : NSObject {
    ...
    private class ZLDoubleTapGestureRecognizer: UITapGestureRecognizer { }
    ...
    func handlePan(recognizer: UIPanGestureRecognizer) {
        ...
        if swipeableView.activeViews().first != recognizer.view {
          return
        }
    ...
    func handleDoubleTap(recognizer: UITapGestureRecognizer) {
      ...
      let location = recognizer.locationInView(containerView)
      swipeableView.didDoubleTap?(view: topView, atLocation: location)
    }
