...
extension ShelfView.DataController: UICollectionViewDataSource, UICollectionViewDelegate {
  ...
  func collectionView(collectionView: UICollectionView, cellForItemAtIndexPath indexPath: NSIndexPath) -> UICollectionViewCell {
    ...
    if let view = view, let dataSource = view.dataSource {
      ...
      dataSource.shelfView(view, itemCell: cell, indexPath: indexPath)
    }
...
extension ShelfView.DataController: UITableViewDataSource {
  ...
  func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {
    ...
    if let view = view, let dataSource = view.dataSource {
      dataSource.shelfView(view, sectionCell: cell, titleForHeaderInSection: indexPath.row)
